...
% logRBNull_FOS = makeNullDataset(logRB(rbFinal.fiber_type == 'FOS',:));
% logRBNull_Glucan = makeNullDataset(logRB(rbFinal.fiber_type == 'Glucan',:));
% logRBNull_Pectin = makeNullDataset(logRB(rbFinal.fiber_type == 'Pectin',:));
% logRBNull_RS = makeNullDataset(logRB(rbFinal.fiber_type == 'RS',:));
...
%     % Now for each fiber separately
%     taxaNow_allFibers_allDonors_logRB_null_FOS = logRBNull_FOS(:,i);
%     taxaNow_allFibers_allDonors_logRB_null_Glucan = logRBNull_Glucan(:,i);
%     taxaNow_allFibers_allDonors_logRB_null_Pectin = logRBNull_Pectin(:,i);
%     taxaNow_allFibers_allDonors_logRB_null_RS = logRBNull_RS(:,i);
...
hold on
box on
scatter(MAD_logRB(:,1), STDAD_logRB(:,1), 8, "filled", markerStyle{1}, 'MarkerFaceColor', colors(1,:))
[~, xModel, yModel, pValTxt, ~] = linearReg(MAD_logRB(:,1), STDAD_logRB(:,1));
p1 = plot(xModel, yModel, 'r-', 'LineWidth', 1);
leg = legend(p1, pValTxt);
leg.Location = 'NorthWest';
ylabel('STD among donors')
xlabel('Log change RB')
title('FOS')
xlim([-2, 2])
ylim([0, 1.2])
yticks(0:0.2:1.2)
...
hold on
box on
scatter(MAD_logRB_null(:,1), STDAD_logRB_null(:,1), 8, "filled", markerStyle{1}, 'MarkerFaceColor', colors(1,:))
[~, xModel, yModel, pValTxt, ~] = linearReg(MAD_logRB_null(:,1), STDAD_logRB_null(:,1));
p1 = plot(xModel, yModel, 'r-', 'LineWidth', 1);
leg = legend(p1, pValTxt);
leg.Location = 'NorthWest';
ylabel('STD among donors')
...
hold on
box on
scatter(MAD_logRB(:,2), STDAD_logRB(:,2), 8, "filled", markerStyle{2}, 'MarkerFaceColor', colors(2,:))
[~, xModel, yModel, pValTxt, ~] = linearReg(MAD_logRB(:,2), STDAD_logRB(:,2));
p1 = plot(xModel, yModel, 'r-', 'LineWidth', 1);
leg = legend(p1, pValTxt);
leg.Location = 'NorthWest';
ylabel('STD among donors')
...
hold on
box on
scatter(MAD_logRB_null(:,2), STDAD_logRB_null(:,2), 8, "filled", markerStyle{2}, 'MarkerFaceColor', colors(2,:))
[~, xModel, yModel, pValTxt, ~] = linearReg(MAD_logRB_null(:,2), STDAD_logRB_null(:,2));
p1 = plot(xModel, yModel, 'r-', 'LineWidth', 1);
leg = legend(p1, pValTxt);
leg.Location = 'NorthWest';
ylabel('STD among donors')
...
hold on
box on
scatter(MAD_logRB(:,3), STDAD_logRB(:,3), 8, "filled", markerStyle{3}, 'MarkerFaceColor', colors(3,:))
[~, xModel, yModel, pValTxt, ~] = linearReg(MAD_logRB(:,3), STDAD_logRB(:,3));
p1 = plot(xModel, yModel, 'r-', 'LineWidth', 1);
leg = legend(p1, pValTxt);
leg.Location = 'NorthWest';
ylabel('STD among donors')
...
hold on
box on
scatter(MAD_logRB_null(:,3), STDAD_logRB_null(:,3), 8, "filled", markerStyle{3}, 'MarkerFaceColor', colors(3,:))
[~, xModel, yModel, pValTxt, ~] = linearReg(MAD_logRB_null(:,3), STDAD_logRB_null(:,3));
p1 = plot(xModel, yModel, 'r-', 'LineWidth', 1);
leg = legend(p1, pValTxt);
leg.Location = 'NorthWest';
ylabel('STD among donors')
...
hold on
box on
scatter(MAD_logRB(:,4), STDAD_logRB(:,4), 8, "filled", markerStyle{4}, 'MarkerFaceColor', colors(4,:))
[~, xModel, yModel, pValTxt, ~] = linearReg(MAD_logRB(:,4), STDAD_logRB(:,4));
p1 = plot(xModel, yModel, 'r-', 'LineWidth', 1);
leg = legend(p1, pValTxt);
leg.Location = 'NorthWest';
ylabel('STD among donors')
...
hold on
box on
scatter(MAD_logRB_null(:,4), STDAD_logRB_null(:,4), 8, "filled", markerStyle{4}, 'MarkerFaceColor', colors(4,:))
[~, xModel, yModel, pValTxt, ~] = linearReg(MAD_logRB_null(:,4), STDAD_logRB_null(:,4));
p1 = plot(xModel, yModel, 'r-', 'LineWidth', 1);
leg = legend(p1, pValTxt);
leg.Location = 'NorthWest';
ylabel('STD among donors')
...
for i = 1:width(MAD_logRB)
    ...
    scatter(MAD_logRB(:,i), STDAD_logRB(:,i), 8, "filled", markerStyle{i}, 'MarkerFaceColor', colors(i,:))
...
% Linear regression
[~, xModel, yModel, pValTxt, ~] = linearReg(MAD_all, STDAD_all);
...
title('All fibers together')
xlim([-2, 2])
ylim([0, 1.2])
yticks(0:0.2:1.2)
xticks(-2:0.5:2)

%% All fibers Null model
...
for i = 1:width(MAD_logRB)
    ...
    scatter(MAD_logRB_null(:,i), STDAD_logRB_null(:,i), 8, "filled", markerStyle{i}, 'MarkerFaceColor', colors(i,:))
...
% Linear regression
[~, xModelNull, yModelNull, pValTxt, ~] = linearReg(MAD_all_null, STDAD_all_null);
...
set(gcf, 'Position', [473.800000000000	273	836	748.800000000000])
sgtitle('Cantu Jungles and Hamaker 2021: Variability (y) vs Intensity (x)')

% Get number of points on each graph
nRealPts = numel(MAD_all(~isnan(MAD_all)))
nNullPts = numel(MAD_all_null(~isnan(MAD_all_null)))
